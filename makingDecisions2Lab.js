...
//Code Here
var lastItemRemoved = arr.pop(5)
console.log(arr, `Item removed = `,lastItemRemoved)
...
//Code Here
for(let i = 0; i < myFavoriteNumbers; i++){
  if (myFavoriteNumbers <= myFavoriteNumbers.length){
